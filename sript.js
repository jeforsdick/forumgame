...
const roleSummaries = \{\
  "best-fit":\
    "Your group consistently chose supports that matched the implementer\'92s current need. Across the scenario, the pathway emphasized fit, timing, and the idea that coaching intensity should change as teacher needs change.",\
  workable:\
  ...
  mismatch:\
    "Your group chose options that were least aligned with the teacher\'92s current barrier. This pathway helps surface common ways support can miss the mark, such as waiting too long, fading too early, or targeting the wrong problem."\
\};\
\
